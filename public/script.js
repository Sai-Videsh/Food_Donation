...
async function displayData() {
  const endpoints = [
      { url: 'http://localhost:5500/api/donors', title: 'Donors' },
      { url: 'http://localhost:5500/api/recipients', title: 'Recipients' },
      { url: 'http://localhost:5500/api/fooditems', title: 'Food Items' },
      { url: 'http://localhost:5500/api/donation_history', title: 'Donations' },
  ];
